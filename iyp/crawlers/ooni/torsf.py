...
class Crawler(BaseCrawler):
    ...
    def run(self):
        ...
        # Fetch data
        grabber.download_and_extract(self.repo, tmpdir, "torsf")
        ...
        testdir = os.path.join(tmpdir, "torsf")
    ...
    def batch_add_to_iyp(self):
        ...
        torsf_id = self.iyp.batch_get_nodes_by_single_prop(
            "Tag", "label", {"Tor Snowflake"}
        ).get("Tor Snowflake")
